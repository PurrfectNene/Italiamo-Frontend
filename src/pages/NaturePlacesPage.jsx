...
function NaturePlacesPage() {
  ...
  useEffect(() => {
    axios
      .get(`${import.meta.env.VITE_API_URL}/api/places/type/Nature`)
      .then((response) => {
  ...
  return (
    <div>
      <div
        style={{
          backgroundImage:
            'url("https://www.dolomititour.com/images/slider/04-unesco-dolomiten/dolomiti-unesco.jpg")',
      ...
      >
        <h2 style={{ fontSize: "36px" }}>Explore Natural Wonders</h2>
        <p style={{ fontSize: "20px" }}>
          Explore locations brimming with natural wonders and breathtaking
