...
function VillagePlacesPage() {
  ...
  useEffect(() => {
    axios
      .get(`${import.meta.env.VITE_API_URL}/api/places/type/Villages`)
      .then((response) => {
  ...
  return (
    <div>
      <div
        style={{
          backgroundImage:
            'url("https://media.istockphoto.com/id/176431489/photo/picturesque-corner-of-a-quaint-tuscan-hill-town-italy.jpg?s=612x612&w=0&k=20&c=Cmxn4pIM1hu21d-kdG7mYSvlnsNTLjMrV7WfKuHgzRg=")',
      ...
      >
        <h2 style={{ fontSize: "36px" }}>Explore Charming Villages</h2>
        <p style={{ fontSize: "20px" }}>
          Discover quaint villages and their unique charm.
        </p>
      </div>
...
export default VillagePlacesPage;
