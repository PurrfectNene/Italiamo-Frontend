...
function AllCitiesPage() {
  ...
  return (
    <div>
      <div style={{ backgroundImage: 'url("https://i0.wp.com/www.viaggiascrittori.com/wp-content/uploads/2019/01/43904814971_95aecd48bc_b.jpg?fit=1024%2C683&ssl=1")', backgroundSize: 'cover', backgroundPosition: 'center', minHeight: '50vh' }}>
        <h1 style={{ position: 'absolute', left: '50%', transform: 'translateX(-50%)', fontWeight: 'bold', color: '#fff', fontSize: '46px' }}>All Italian Cities</h1>
      </div>
      <div style={{ backgroundColor: 'rgba(242, 240, 228, 0.2)', padding: '20px', textAlign: 'center' }}>
        <h2 style={{ fontSize: '36px' }}>Italian cities are unique places full of art, history and culture that will easily enchant you</h2>
        <p style={{ fontSize: '20px' }}>From the art filled streets of Florence to the romantic canals of Venice, every Italian city has unparalleled charm waiting to be discovered. Enjoy a relaxing holiday, discover some of the most incredible history in the world, and taste delicious food and wine for which Italy is famous worldwide.</p>
      </div>
