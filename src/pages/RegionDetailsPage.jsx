...
function RegionDetailsPage() {
    ...
    useEffect(() => {
        axios.get(`${import.meta.env.VITE_API_URL}/api/regions/${id}`)
            .then(response => {
        ...
        axios.get(`${import.meta.env.VITE_API_URL}/api/regions/${id}/cities`)
            .then(response => {
                setCities(response.data);
                axios.get(`${import.meta.env.VITE_API_URL}/api/regions/${id}/places`)
                    .then(response => {
