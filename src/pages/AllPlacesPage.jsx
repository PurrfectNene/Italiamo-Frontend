...
function AllPlacesPage() {
    ...
    useEffect(() => {
        axios.get(`${import.meta.env.VITE_API_URL}/api/places`) // Fetch all places
            .then(response => {
    ...
    return (
        <div>
            <div style={{ backgroundImage: 'url("https://www.traveltaormina.com/templates/yootheme/cache/b9/teatro-greco-taormina-b9f83c50.webp")', backgroundSize: 'cover', backgroundPosition: 'center', minHeight: '50vh' }}>
                <h1 style={{ position: 'absolute',left: '50%', transform: 'translateX(-50%)', fontWeight: 'bold', color: '#fff', fontSize: '46px' }}>All Places</h1>
            </div>
            <div style={{backgroundColor: 'rgba(242, 240, 228, 0.2)', padding: '20px', textAlign: 'center' }}>
                ...
                <p style={{fontSize: '20px'}}>Discover the beauty and uniqueness of all places in Italy.</p>
            </div>
